...
const AnimGlucose = () => (
  <svg viewBox="0 0 260 118" style={{ display:'block', width:'100%', height:'118px' }}>
    <defs><clipPath id="anim-gc-clip"><path d="M130,8 C130,8 170,58 170,86 C170,108 152,120 130,120 C108,120 90,108 90,86 C90,58 130,8 130,8Z"/></clipPath></defs>
    <path d="M130,8 C130,8 170,58 170,86 C170,108 152,120 130,120 C108,120 90,108 90,86 C90,58 130,8 130,8Z" stroke="rgba(255,255,255,0.5)" strokeWidth="2" fill="rgba(255,255,255,0.1)"/>
    ...
    <text x="130" y="90" textAnchor="middle" fontSize="22" fontWeight="800" fill="rgba(255,255,255,0.95)" style={{ fontFamily:'system-ui,sans-serif', letterSpacing:'-0.5px' }}>98</text>
    <text x="130" y="106" textAnchor="middle" fontSize="10" fontWeight="600" fill="rgba(255,255,255,0.7)" style={{ fontFamily:'system-ui,sans-serif' }}>mg/dL</text>
  </svg>
);

const AnimVitals = () => (
  <svg viewBox="0 0 260 118" style={{ display:'block', width:'100%', height:'118px' }}>
    {[{ cx:52, label:'♥', val:'72', unit:'bpm', d:'0s' },{ cx:130, label:'⬤', val:'36.6', unit:'°C', d:'0.5s' },{ cx:208, label:'◯', val:'98%', unit:'SpO₂', d:'1s' }].map(({ cx, label, val, unit, d }, i) => (
...
const AnimBloodDraw = () => (
  <svg viewBox="0 0 260 118" style={{ display:'block', width:'100%', height:'118px' }}>
    <defs><clipPath id="anim-bd-clip"><rect x="104" y="32" width="52" height="80" rx="8"/></clipPath></defs>
    ...
    {[44,56,68,80].map(y => <line key={y} x1="150" y1={y} x2="155" y2={y} stroke="rgba(255,255,255,0.45)" strokeWidth="1.5"/>)}
...
const AnimWellness = () => (
  <svg viewBox="0 0 260 118" style={{ display:'block', width:'100%', height:'118px' }}>
    ...
    <path d="M110,50 C110,43 118,40 130,40 C142,40 150,43 150,50 L155,100 L140,100 L130,82 L120,100 L105,100Z" fill="rgba(255,255,255,0.9)"/>
    ...
    <g className="wa-c1"><circle cx="176" cy="25" r="14" fill="rgba(255,255,255,0.88)"/><path d="M170,25 L174.5,30 L182,19" stroke="rgba(0,0,0,0.3)" strokeWidth="2.2" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g>
    <g className="wa-c2"><circle cx="68" cy="60" r="14" fill="rgba(255,255,255,0.88)"/><path d="M62,60 L66.5,65 L74,54" stroke="rgba(0,0,0,0.3)" strokeWidth="2.2" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g>
    <g className="wa-c3"><circle cx="192" cy="88" r="14" fill="rgba(255,255,255,0.88)"/><path d="M186,88 L190.5,93 L198,82" stroke="rgba(0,0,0,0.3)" strokeWidth="2.2" fill="none" strokeLinecap="round" strokeLinejoin="round"/></g>
  </svg>
);
...
const AnimPostSurgical = () => (
  <svg viewBox="0 0 260 118" style={{ display:'block', width:'100%', height:'118px' }}>
    ...
    <defs>
      <linearGradient id="anim-ps-shine" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stopColor="rgba(255,255,255,0)"/><stop offset="45%" stopColor="rgba(255,255,255,0.55)"/><stop offset="100%" stopColor="rgba(255,255,255,0)"/></linearGradient>
      <clipPath id="anim-ps-clip"><path d="M118,22 h24 v25 h25 v24 h-25 v25 h-24 v-25 h-25 v-24 h25 Z"/></clipPath>
    </defs>
...
const AnimMedication = () => (
  <svg viewBox="0 0 260 118" style={{ display:'block', width:'100%', height:'118px' }}>
    <g className="med-main"><rect x="94" y="52" width="72" height="36" rx="18" fill="rgba(255,255,255,0.92)"/><rect x="94" y="52" width="36" height="36" rx="18" fill="rgba(255,255,255,0.6)"/><line x1="130" y1="52" x2="130" y2="88" stroke="rgba(255,255,255,0.3)" strokeWidth="1.5"/></g>
    <g className="med-p1"><rect x="44" y="18" width="28" height="15" rx="7.5" fill="rgba(255,255,255,0.82)"/><rect x="44" y="18" width="14" height="15" rx="7.5" fill="rgba(255,255,255,0.55)"/></g>
    <g className="med-p2"><rect x="188" y="12" width="26" height="14" rx="7" fill="rgba(255,255,255,0.78)"/><rect x="188" y="12" width="13" height="14" rx="7" fill="rgba(255,255,255,0.5)"/></g>
    <g className="med-p3"><rect x="118" y="8" width="24" height="13" rx="6.5" fill="rgba(255,255,255,0.72)"/><rect x="118" y="8" width="12" height="13" rx="6.5" fill="rgba(255,255,255,0.45)"/></g>
    <text x="220" y="56" textAnchor="middle" fontSize="28" fontWeight="900" fill="rgba(255,255,255,0.88)" style={{ fontFamily:'system-ui' }} className="med-plus">+</text>
  </svg>
);

const AnimNursing = () => (
  <svg viewBox="0 0 260 118" style={{ display:'block', width:'100%', height:'118px' }}>
    <path d="M96,12 L96,36 Q96,44 104,44 Q112,44 112,36 L112,12" stroke="rgba(255,255,255,0.9)" strokeWidth="4.5" fill="none" strokeLinecap="round"/>
    <path d="M148,12 L148,36 Q148,44 156,44 Q164,44 164,36 L164,12" stroke="rgba(255,255,255,0.9)" strokeWidth="4.5" fill="none" strokeLinecap="round"/>
    <path d="M104,44 Q104,72 130,72 Q156,72 156,44" stroke="rgba(255,255,255,0.9)" strokeWidth="4.5" fill="none" strokeLinecap="round"/>
...
const SERVICE_META = [
  {
    ...
    sq: {
      name: 'Matja e Presionit të Gjakut',
      desc: 'Tre matje të kalibruara me shënime infermiere dhe regjistrim i menjëhershëm në panelin shëndetësor.',
      detail: 'Infermierja jonë përdor një sfigmomanometër dixhital të kalibruar për të marrë tre matje me interval 2-minutësh. Rezultatet regjistrohen menjëherë në panelin tuaj shëndetësor dhe krahasohen me vizitat tuaja të mëparshme.',
      included: ['Matja sistoliko-diastolike','3 matje të njëpasnjëshme për saktësi','Rezultate të krahasuara me historikun bazë','Shënime infermiere për trendet dhe anomalitë','Alarm i menjëhershëm nëse vlerat janë kritike'],
      bestFor: ['Hipertensioni', 'Monitorimi i medikamenteve', 'Mirëqenia e përgjithshme'],
    },
  },
  {
    ...
    sq: {
      name: 'Testi i Glukozës në Gjak',
      desc: 'Test me shpim gishti me rezultate në kohë reale, udhëzime dietike dhe rishikim medikamentesh.',
      detail: 'Duke përdorur një glukometër të çertifikuar, infermierja jonë mat nivelin e sheqerit në gjak dhe e regjistron në kohë reale. Rezultatet janë menjëherë të dukshme në panelin tuaj, dhe çdo vlerë jashtë kufijve nxit një telefonatë vijuese nga infermierja.',
      included: ['Test i glukozës me shpim gishti','Regjistrimi i leximit në dosjen shëndetësore','Alarm nëse nivelet janë jashtë kufijve të sigurt','Krahasim para dhe pas vaktit disponibël','Udhëzim infermiereje për dietën dhe medikamentet'],
      bestFor: ['Menaxhimi i diabetit', 'Kontrolle para/pas vaktit', 'Rregullimet e medikamenteve'],
    },
  },
  {
    color: '#0D9488', colorLight: 'rgba(13,148,136,0.08)', colorBorder: 'rgba(13,148,136,0.18)',
    ...
    sq: {
      name: 'Kontrolli i Plotë i Vitaleve',
      desc: 'Pesë shenja vitale kryesore të matura me pajisje klinike dhe të sinjalizuara menjëherë.',
      detail: 'Një pamje e plotë e gjendjes fiziologjike të të dashurit tuaj. Të pesë shenjat vitale kryesore maten me pajisje klinike, regjistrohen në dosjen shëndetësore dhe sinjalizohen nëse ndonjë vlerë bie jashtë kufijve normalë.',
      included: ['Kontrolli i ritmit dhe frekuencës kardiake','Matja e temperaturës trupore','Leximi i SpO₂ (ngopja me oksigjen)','Vlerësimi i shkallës respiratore','Vitalet e plota të regjistruara në raportin shëndetësor'],
      bestFor: ['Rimëkëmbje pas sëmundjes', 'Monitorim i kushteve kronike', 'Mirëqenie e përgjithshme'],
    },
  },
  {
    ...
    sq: {
      name: 'Marrja e Gjakut & Analizat',
      desc: 'Marrja e gjakut në shtëpi me korrier të ditës tek laboratorët e çertifikuar shqiptarë.',
      detail: 'Nuk ka më dhoma pritjeje. Infermierja jonë merr mostër në shtëpi, siguron trajtim të duhur dhe zinxhir të ftohtë nëse kërkohet, dhe e dërgon drejtpërdrejt në një laborator të çertifikuar shqiptar. Rezultatet zakonisht mbërrijnë brenda 24–48 orësh.',
      included: ['Marrja venoze e gjakut nga infermiere e çertifikuar','Korrier i ditës tek laboratori i çertifikuar shqiptar','Rezultate të ndara nëpërmjet panelit shëndetësor','Ndjekje e infermierës për vlerat jonormale','Mbështet të gjitha panelet standarde (CBC, lipide, etj.)'],
      bestFor: ['Panele rutinë laboratori', 'Monitorim medikamentesh', 'Kontrolle para-kirurgjike'],
    },
  },
  {
    ...
    sq: {
      name: 'Vlerësimi i Mirëqenies',
      desc: 'Vlerësim gjithëpërfshirës fizik, mendor, i medikamenteve dhe i sigurisë në shtëpi.',
      detail: 'Vizita jonë më gjithëpërfshirëse. Infermierja kalon një orë të plotë duke vlerësuar mirëqenien fizike dhe mendore, duke rishikuar të gjitha medikamentet aktuale dhe duke sinjalizuar çdo rrezik mjedisor. Një raport i detajuar me foto të çdo shqetësimi dërgohet drejtpërdrejt tek familja.',
      included: ['Vlerësim i plotë fizik','Kontroll i shëndetit mendor dhe humorit','Rishikim i medikamenteve dhe respektimit','Vlerësim i sigurisë së mjedisit të shtëpisë','Raport i detajuar për familjen'],
      bestFor: ['Të moshuar që jetojnë vetëm', 'Dalje pas spitalit', 'Qetësi shpirtërore'],
    },
  },
  {
    ...
    sq: {
      name: 'Kujdesi Pas Kirurgjisë',
      desc: 'Kujdes steril i plagëve, kontrolle dreni dhe raportim me kirurgun në shtëpi.',
      detail: 'Pas çdo ndërhyrjeje kirurgjikale, infermieret tona ofrojnë kujdes klinik në shtëpi. Ato inspektojnë vendin e plagës, ndryshojnë fashimet me teknikë sterile, vlerësojnë infeksionin ose komplikimet dhe hartojnë një raport për t\'ia dërguar kirurgut trajtues.',
      included: ['Inspektim i plagës & ndryshim profesional fashimi','Kontrolli i integritetit të drenit dhe qepjeve','Vlerësim i dhimbjes, ënjtjes dhe infeksionit','Rishikim i respektimit të medikamenteve dhe dozave','Raport lidhës me kirurgun nëse gjenden anomali'],
      bestFor: ['Rimëkëmbje pas kirurgjisë', 'Menaxhimi i plagëve', 'Përgatitje për heqje dreni'],
    },
  },
  {
    ...
    sq: {
      name: 'Administrimi i Medikamenteve',
      desc: 'Dozim sipas orarit me monitorim efektesh anësore dhe regjistër të plotë medikamentesh.',
      detail: 'Infermieret tona sigurojnë që medikamentet të merren saktë, në kohën e duhur dhe në dozën e duhur. Çdo administrim regjistrohet, dhe çdo efekt anësor shqetësues raportohet menjëherë tek familja dhe sinjalizohet në dosjen shëndetësore.',
      included: ['Administrim medikamentesh sipas orarit','Verifikim i dozës','Monitorim dhe raportim i efekteve anësore','Mbështetje për injeksione dhe IV','Regjistri i medikamenteve i përditësuar pas çdo vizite'],
      bestFor: ['Sëmundje kronike', 'Kujdes post-operativ', 'Pacientë të moshuar'],
    },
  },
  {
    ...
    sq: {
      name: 'Infermieri e Përgjithshme',
      desc: 'Plan infermiereje i personalizuar për nevoja kujdesi komplekse, të vazhdueshme ose të personalizuara.',
      detail: 'Kur asnjë shërbim i vetëm nuk mjafton, Infermierja e Përgjithshme e mbulon. Infermierja jonë vlerëson situatën e plotë të pacientit dhe ofron kujdes të personalizuar — nga shoqëria dhe mbështetja e lëvizshmërisë deri te monitorimi klinik dhe koordinimi me familjen.',
      included: ['Plan infermiereje i personalizuar për çdo pacient','Vlerësim dhe adaptim i vazhdueshëm','Komunikim me familjen pas çdo vizite','Koordinim me mjekët nëse nevojitet','Raport i plotë vizite në panelin shëndetësor'],
      bestFor: ['Nevoja kujdesi komplekse', 'Kushte afatgjata', 'Kërkesa të personalizuara'],
    },
  },
];
...
const UI = {
  en: {
    ...
    hoverHint: 'Hover to pause · Click the card to explore',
    serviceLabel: 'Service',
  },
  sq: {
    whatsIncluded: 'Çfarë përfshihet',
    bestFor: 'Më i mirë për',
    viewDetails: 'Shiko detajet',
    bookService: 'Rezervo këtë shërbim →',
    hoverHint: 'Qëndroni për të ndaluar · Klikoni kartën për të eksploruar',
    serviceLabel: 'Shërbimi',
  },
};
const ui = (lang, key) => (UI[lang] || UI.en)[key];
const svc = (m, lang) => ({ ...m[lang] || m.en });

// ── Component ────────────────────────────────────────────────────────────────

export default function ServiceCardsSection({ lang = 'en', services }) {
  ...
  const m = svc(meta, lang);

  const modalContent = mounted && modalOpen ? createPortal(
    <div
      ...
      >
        ...
        <div style={{ padding:'36px 36px 28px', position:'relative', borderRadius:'24px 24px 0 0', overflow:'hidden', background: meta.gradient }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:14, marginBottom:16, position:'relative', zIndex:1 }}>
            ...
            <div>
              <div style={{ fontSize:10, fontWeight:700, color:'rgba(255,255,255,0.65)', textTransform:'uppercase', letterSpacing:'1px', marginBottom:4 }}>{ui(lang,'serviceLabel')} {String(current + 1).padStart(2, '0')}</div>
          ...
          <h2 style={{ fontSize:'clamp(20px,3vw,26px)', fontWeight:800, color:'#fff', margin:'0 0 8px', letterSpacing:'-0.5px', lineHeight:1.2, position:'relative', zIndex:1 }}>{m.name}</h2>
          <p style={{ fontSize:13, color:'rgba(255,255,255,0.78)', margin:0, lineHeight:1.65, maxWidth:480, position:'relative', zIndex:1 }}>{m.detail}</p>
        </div>

        {/* Body */}
        <div style={{ padding:'28px 36px 36px' }}>
          <div style={{ marginBottom:24 }}>
            <div style={{ fontSize:11, fontWeight:700, color:'#9CA3AF', textTransform:'uppercase', letterSpacing:'1px', marginBottom:12 }}>{ui(lang,'whatsIncluded')}</div>
            <div style={{ display:'flex', flexDirection:'column', gap:7 }}>
              {m.included.map((item, ii) => (
          ...
          <div style={{ marginBottom:28 }}>
            <div style={{ fontSize:11, fontWeight:700, color:'#9CA3AF', textTransform:'uppercase', letterSpacing:'1px', marginBottom:10 }}>{ui(lang,'bestFor')}</div>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:10 }}>
            ...
            <Link href={`/${lang}/signup?role=client`} style={{ flex:1, maxWidth:200 }}>
              <button
    ...
    <>
      <style>{`
        ...
        .fan-scene {
          ...
          height:460px; margin-bottom:32px; user-select:none;
          perspective:1100px; perspective-origin:50% 50%;
        }
        .fan-card {
          position:absolute; width:300px; background:#fff; border-radius:22px; overflow:hidden;
          box-shadow:0 4px 20px rgba(0,0,0,0.07); border:1px solid #E9EBF0;
        ...
        .fan-card.is-center { cursor:pointer; box-shadow:0 20px 56px rgba(0,0,0,0.14); z-index:10; }
        ...
        .fan-body { padding:18px 22px 22px; display:flex; flex-direction:column; gap:9px; }
        ...
        /* ── Modal (portal — renders at document.body) ── */
        .svc-overlay {
      ...
      >
        ...
        {SERVICE_META.map((sm, i) => {
          const pos = getPos(i);
          if (Math.abs(pos) > 1) return null;
          const isCenter = pos === 0;
          const card = svc(sm, lang);
          return (
            <div
              key={i}
            ...
            >
              <div className="fan-lift">
                <div className="fan-head" style={{ background: sm.gradient }}>
                  <sm.Anim />
                </div>
                <div className="fan-body">
                  <div className="fan-name">{card.name}</div>
                  <div className="fan-desc">{card.desc}</div>
                  <div className="fan-tags">
                    {card.bestFor.slice(0, 2).map(t => (
                      <span key={t} className="fan-tag" style={{ color: sm.color, background: sm.colorLight, borderColor: sm.colorBorder }}>{t}</span>
                    ))}
                  </div>
                  <div className="fan-footer">
                    <span className="fan-dur" style={{ color: sm.color, background: sm.colorLight }}>
                      <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                      {sm.duration}
                    </span>
                    {isCenter && (
                      <span className="fan-cta" style={{ color: sm.color }}>
                        {ui(lang,'viewDetails')}
      ...
      <p className="fan-hint">{ui(lang,'hoverHint')}</p>

      <div className="fan-dots">
        {SERVICE_META.map((sm, i) => (
          <button key={i} className="fan-dot" onClick={() => rotateTo(i)}
            style={{ width: i === current ? 22 : 6, background: i === current ? sm.color : '#CBD5E1' }}
            aria-label={`Go to ${svc(sm, lang).name}`}/>
        ))}
      </div>

      {/* Modal rendered via portal at document.body — bypasses any containing block from perspective/filter/overflow */}
      {modalContent}
    </>
  );
}
