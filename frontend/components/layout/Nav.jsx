      ...
      <div style={{ maxWidth:1100, margin:'0 auto', padding:'0 24px', display:'flex', alignItems:'center', justifyContent:'space-between', height:64 }}>
        ...
        <div style={{ display:'flex', gap:8, alignItems:'center' }}>
          ...
          <Link href={`/${lang}/signup`}>
            <button style={{ fontSize:13, fontWeight:600, padding:'9px 18px', borderRadius:8, border:'none', background:C.primary, color:'#fff', cursor:'pointer', boxShadow:'0 1px 3px rgba(37,99,235,0.3)' }}>{t(lang,'nav.getStarted')}</button>
          </Link>
        </div>
      </div>
    </nav>
