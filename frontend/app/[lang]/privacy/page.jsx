...
const TR = {
  en: {
    ...
    sections: [
      ...
      { h: '4. Data sharing', p: 'We do not sell your personal data. We share data only with: nurses assigned to your visits, payment processors (PayPal), email service providers (Resend), and file storage providers (Cloudinary). All partners are bound by data protection agreements.' },
  ...
  sq: {
    ...
    sections: [
      ...
      { h: '4. Ndarja e të dhënave', p: 'Nuk shesim të dhënat tuaja personale. Ndajmë të dhënat vetëm me: infermierët e caktuar për vizitat tuaja, procesuesit e pagesave (PayPal), ofruesit e shërbimeve email (Resend) dhe ofruesit e ruajtjes së skedarëve (Cloudinary). Të gjithë partnerët janë të lidhur me marrëveshje mbrojtjeje të të dhënave.' },
